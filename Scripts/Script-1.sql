...
-- 회원 관리
-- 학생 회원 가입
INSERT INTO STUDENT VALUES('01011111111', '홍길동', '1111','M', '2019-05-08','서울시 강남구 찬주동', 'N','N');
...
'송희 기반 JAVA IT 양성과정', '2019-06-12', '1');
...
SELECT FORM_SEQ, APP_DATE, COURSECODE, COURSENAME, STM, START_DATE 결석시작일
	FROM APP_FORM JOIN IS_APPROVE
		USING(FORM_SEQ)
			JOIN COURSE
			USING(COURSECODE)
		WHERE STUDENT_ID = '01011111111' AND IS_APPROVE.STM = 'Y'
...
WHERE SIGNATURE.SIGNATURE_ID = '01012345678' AND APP_FORM.FORM_SEQ = '2' AND IS_APPROVE.STM = 'Y';
...
INSERT INTO APP_FORM
		...
		VALUES
		   ...
		   'C00001', '감기로 출석이 어려움', '2019-05-03', 3, '진단서.JPG', '01082081952_첨부.JPG');
		   
-- 신청 상태 테이블 연결
INSERT INTO IS_APPROVE(FORM_SEQ, STM)
VALUES((SELECT MAX(FORM_SEQ) FROM APP_FORM WHERE STUDENT_ID='01082081952'), 'N');
