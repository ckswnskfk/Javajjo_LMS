...
<%-- 	<h4>과제 날짜 : ${testsession.testhay}</h4> --%>
	<input type="button" value="성적확인" class="btn btn-primary active" onclick="StuScore()">
	<input type="button" value="뒤로가기" class="btn btn-primary disabled" onclick="javascript:location.href='./test_Course_Result.do'"> 
</div>
