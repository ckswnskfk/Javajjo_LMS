				...
				<div id="home" class="tab-pane in active">
					<div class="row">
						<div class="col-xs-12 col-sm-9" style="text-align: center">
							<h4 class="dark">
								<span class="middle" style="font-size: 25px; margin-top: 20px; float:left">${member.name} 님의 정보 수정</span>
							</h4>
							<form action="#" onsubmit="return adm_mod()">
									...
									<div class="form-group" style="margin-top: 20px">
										<div class="col-sm-offset-2 col-sm-10">
											...
											<input type="button" class="btn btn-primary disabled"
											 value="취소" onclick="location.href='./admin_info.do'" style="font-size: 18px"/>
										</div>
									</div>
